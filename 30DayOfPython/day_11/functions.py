...
def calculate_slope(x1, y1, x2, y2):
    return (y2 - y1) / (x2 - x1)
print(calculate_slope(2, 6, 4, 10))
...
print(solve_quadratic_eqn(3,2,4))
...
def is_empty(param):
    return len(param) == 0
print(is_empty(""))
print(is_empty([2, 4, 6]))
print(is_empty([]))
print(is_empty("Alphabet"))
...
numbers = [2, 4, 3,3, 5, 6, 7, 8,8,8,10,15]
...
top_10 = most_spoken_languages()
print(top_10)

top_20 = most_spoken_languages(20)
print(top_20)
...
top_10 = most_populated_countries()
print(top_10)


# 20 most populated countries in the world
top_20 = most_populated_countries(20)
print(top_20)